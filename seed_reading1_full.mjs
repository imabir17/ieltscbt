...
const test = stmt.get('IELTS Reading Test 1');
...
// Delete existing modules for this test
...
const questions = JSON.stringify([
  {
    ...
    passage: `It is not easy to be systematic and objective about language study. Popular linguistic debate regularly deteriorates into invective and polemic. Language belongs to everyone, so most people feel they have a right to hold an opinion about it. And when opinions differ, emotions can run high. Arguments can start as easily over minor points of usage as over major policies of linguistic education.
...
NOT GIVEN if it is impossible to say what the writer thinks about this`,
        questions: [
          { id: 1, type: 'yes_no_not_given', text: '1. There are understandable reasons why arguments occur about language.', answer: 'TRUE' },
          { id: 2, type: 'yes_no_not_given', text: '2. People feel more strongly about language education than about small differences in language usage.', answer: 'FALSE' },
          { id: 3, type: 'yes_no_not_given', text: '3. Our assessment of a person’s intelligence is affected by the way he or she uses language.', answer: 'TRUE' },
          { id: 4, type: 'yes_no_not_given', text: '4. Prescriptive grammar books cost a lot of money to buy in the 18th century.', answer: 'NOT GIVEN' },
          { id: 5, type: 'yes_no_not_given', text: '5. Prescriptivism still exists today.', answer: 'TRUE' },
          { id: 6, type: 'yes_no_not_given', text: '6. According to descriptivists it is pointless to try to stop language change.', answer: 'TRUE' },
          { id: 7, type: 'yes_no_not_given', text: '7. Descriptivism only appeared after the 18th century.', answer: 'FALSE' },
          { id: 8, type: 'yes_no_not_given', text: '8. Both descriptivists and prescriptivists have been misrepresented.', answer: 'TRUE' }
        ]
      },
      {
...
I change`,
        questions: [
          { id: 9, type: 'fill_in_the_blank', text: '9. According to ............. there is only one correct form of language.', answer: 'H' },
          { id: 10, type: 'fill_in_the_blank', text: '10. Linguists who take this approach to language place great importance on grammatical .................', answer: 'F' },
          { id: 11, type: 'fill_in_the_blank', text: '11. Conversely, the view of .............., such as Joseph Priestley,', answer: 'A' },
          { id: 12, type: 'fill_in_the_blank', text: '12. is that grammar should be based on ......................', answer: 'C' }
        ]
      },
      {
        ...
        questions: [
          { 
            ...
            text: '13. What is the writer’s purpose in Reading Passage?', 
            options: [
...
NB You may use any letter more than once.`,
        questions: [
          ...
          { id: 15, type: 'matching_paragraphs', text: '15. a way of bringing the power produced on one site back into Britain', answer: 'E' },
          { id: 16, type: 'matching_paragraphs', text: '16. a reference to a previous attempt by Britain to find an alternative source of energy', answer: 'A' },
          { id: 17, type: 'matching_paragraphs', text: '17. mention of the possibility of applying technology from another industry', answer: 'C' }
        ]
      },
      {
        instructions: `Choose FIVE Letters A-J
...
J It is best produced in the vicinity of coastlines with particular features.`,
        questions: [
          { id: 18, type: 'fill_in_the_blank', text: '18. ', answer: 'A' },
          { id: 19, type: 'fill_in_the_blank', text: '19. ', answer: 'D' },
          { id: 20, type: 'fill_in_the_blank', text: '20. ', answer: 'E' },
          { id: 21, type: 'fill_in_the_blank', text: '21. ', answer: 'F' },
          { id: 22, type: 'fill_in_the_blank', text: '22. ', answer: 'J' }
        ]
      },
      {
        instructions: `Label the diagram below. Choose NO MORE THAN TWO WORDS from the passage for each answer.`,
        questions: [
          { id: 23, type: 'fill_in_the_blank', text: '23. Label the diagram (NO MORE THAN TWO WORDS): _______', answer: 'maintenance' },
          { id: 24, type: 'fill_in_the_blank', text: '24. Label the diagram (NO MORE THAN TWO WORDS): _______', answer: 'slow (turning)' },
          { id: 25, type: 'fill_in_the_blank', text: '25. Label the diagram (NO MORE THAN TWO WORDS): _______', answer: 'low pressure' },
          { id: 26, type: 'fill_in_the_blank', text: '26. Label the diagram (NO MORE THAN TWO WORDS): _______', answer: 'cavitation' }
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        questions: [
          ...
          { id: 28, type: 'matching_paragraphs', text: '28. an example of how unnecessary information can be omitted', answer: 'F' },
          { id: 29, type: 'matching_paragraphs', text: '29. a reference to Shannon`s attitude to fame', answer: 'B' },
          { id: 30, type: 'matching_paragraphs', text: '30. details of a machine capable of interpreting incomplete information', answer: 'E' },
          { id: 31, type: 'matching_paragraphs', text: '31. a detailed account of an incident involving information theory', answer: 'A' },
          { id: 32, type: 'matching_paragraphs', text: '32. a reference to what Shannon initially intended to achieve in his research', answer: 'C' }
        ]
      },
      {
...
The probe transmitted pictures of both (33) .......................,and .................... , then left the (34) .................... The freezing temperatures were found to have a negative effect on parts of the space probe. Scientists feared that both the (35)........................ and ......................... were about to stop working. The only hope was to tell the probe to replace them with (36).......................... – but distance made communication with the probe difficult. A (37)........................... was used to transmit the message at the speed of light. The message was picked up by the probe and the switchover took place.`,
        questions: [
          { id: 33, type: 'fill_in_the_blank', text: '33. ', answer: 'jupiter and saturn' },
          { id: 34, type: 'fill_in_the_blank', text: '34. ', answer: 'solar system' },
          { id: 35, type: 'fill_in_the_blank', text: '35. ', answer: 'sensors and circuits' },
          { id: 36, type: 'fill_in_the_blank', text: '36. ', answer: 'spares' },
          { id: 37, type: 'fill_in_the_blank', text: '37. ', answer: 'radio dish' }
        ]
      },
      {
...
NOT GIVEN if there is no information on this`,
        questions: [
          { id: 38, type: 'true_false_not_given', text: '38. The concept of describing something as true or false was the starting point for Shannon in his attempts to send messages over distances.', answer: 'TRUE' },
          { id: 39, type: 'true_false_not_given', text: '39. The amount of information that can be sent in a given time period is determined with reference to the signal strength and noise level.', answer: 'TRUE' },
          { id: 40, type: 'true_false_not_given', text: '40. Products have now been developed which can convey more information than Shannon had anticipated as possible.', answer: 'FALSE' }
        ]
      }
    ]
  }
...
console.log('Successfully updated the test with all 40 questions and full passages!');
