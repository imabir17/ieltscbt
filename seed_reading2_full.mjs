...
const existingTest = stmt.get('IELTS Reading Test 2');
...
if (existingTest) {
  ...
  testId = randomUUID();
  database.prepare('INSERT INTO tests (id, name, type, owner_center_id) VALUES (?, ?, ?, ?)').run(testId, 'IELTS Reading Test 2', 'Academic', null);
}
...
const questions = JSON.stringify([
  {
    ...
    passage: `A Hearing impairment or other auditory function deficit in young children can have a major impact on their development of speech and communication, resulting in a detrimental effect on their ability to learn at school. This is likely to have major consequences for the individual and the population as a whole. The New Zealand Ministry of Health has found from research carried out over two decades that 6-10% of children in that country are affected by hearing loss.
...
Write the correct letter, A-I, in boxes 1-6 on your answer sheet.`,
        questions: [
          { id: 1, type: 'matching_paragraphs', text: '1. an account of a national policy initiative', answer: 'H' },
          { id: 2, type: 'matching_paragraphs', text: '2. a description of a global team effort', answer: 'C' },
          { id: 3, type: 'matching_paragraphs', text: '3. a hypothesis as to one reason behind the growth in classroom noise', answer: 'B' },
          { id: 4, type: 'matching_paragraphs', text: '4. a demand for suitable worldwide regulations', answer: 'I' },
          { id: 5, type: 'matching_paragraphs', text: '5. a list of medical conditions which place some children more at risk from noise than others', answer: 'D' },
          { id: 6, type: 'matching_paragraphs', text: '6. the estimated proportion of children in New Zealand with auditory problems', answer: 'A' }
        ]
      },
      {
        instructions: `Answer the questions below. Choose NO MORE THAN TWO WORDS AND/OR A NUMBER from the passage.`,
        questions: [
          { id: 7, type: 'fill_in_the_blank', text: '7. For what period of time has hearing loss in schoolchildren been studied in New Zealand?', answer: 'two decades' },
          { id: 8, type: 'fill_in_the_blank', text: '8. In addition to machinery noise, what other type of noise can upset children with autism?', answer: 'crowd noise' },
          { id: 9, type: 'fill_in_the_blank', text: '9. What term is used to describe the hearing problems of schoolchildren which have not been diagnosed?', answer: 'invisible disabilities' },
          { id: 10, type: 'fill_in_the_blank', text: '10. What part of the New Zealand Disability Strategy aims to give schoolchildren equal opportunity?', answer: 'objective 3' }
        ]
      },
      {
        instructions: `Choose TWO letters, A-F. The list below includes factors contributing to classroom noise. Which TWO are mentioned by the writer of the passage?
...
F playground games`,
        questions: [
          { id: 11, type: 'fill_in_the_blank', text: '11. ', answer: 'A' },
          { id: 12, type: 'fill_in_the_blank', text: '12. ', answer: 'C' }
        ]
      },
      {
        ...
        questions: [
          { 
            ...
            text: '13. What is the writer’s overall purpose in writing this article?', 
            options: [
    ...
    groups: [
      {
        ...
        questions: [
          { id: 14, type: 'matching_paragraphs', text: '14. examples of different ways in which the parallax principle has been applied', answer: 'F' },
          { id: 15, type: 'matching_paragraphs', text: '15. a description of an event which prevented a transit observation', answer: 'D' },
          { id: 16, type: 'matching_paragraphs', text: '16. a statement about potential future discoveries leading on from transit observations', answer: 'G' },
          { id: 17, type: 'matching_paragraphs', text: '17. a description of physical states connected with Venus which early astronomical instruments failed to overcome', answer: 'E' }
        ]
      },
      {
        instructions: `Look at the following statements and the list of people below. Match each statement with the correct person, A, B, C or D.
List of People
A Edmond Halley
B Johannes Kepler
...
D Johann Franz Encke`,
        questions: [
          { id: 18, type: 'fill_in_the_blank', text: '18. He calculated the distance of the Sun from the Earth based on observations of Venus with a fair degree of accuracy.', answer: 'D' },
          { id: 19, type: 'fill_in_the_blank', text: '19. He understood that the distance of the Sun from the Earth could be worked out by comparing observations of a transit.', answer: 'A' },
          { id: 20, type: 'fill_in_the_blank', text: '20. He realised that the time taken by a planet to go round the Sun depends on its distance from the Sun.', answer: 'B' },
          { id: 21, type: 'fill_in_the_blank', text: '21. He witnessed a Venus transit but was unable to make any calculations.', answer: 'C' }
        ]
      },
      {
...
NOT GIVEN if there is no information on this`,
        questions: [
          { id: 22, type: 'true_false_not_given', text: '22. Halley observed one transit of the planet Venus.', answer: 'FALSE' },
          { id: 23, type: 'true_false_not_given', text: '23. Le Gentil managed to observe a second Venus transit.', answer: 'FALSE' },
          { id: 24, type: 'true_false_not_given', text: '24. The shape of Venus appears distorted when it starts to pass in front of the Sun.', answer: 'TRUE' },
          { id: 25, type: 'true_false_not_given', text: '25. Early astronomers suspected that the atmosphere on Venus was toxic.', answer: 'NOT GIVEN' },
          { id: 26, type: 'true_false_not_given', text: '26. The parallax principle allows astronomers to work out how far away distant stars are from the Earth.', answer: 'TRUE' }
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        questions: [
          { 
            id: 27, 
            type: 'multiple_choice', 
            text: '27. Neuroeconomics is a field of study which seeks to', 
            options: [
          ...
          { 
            id: 28, 
            type: 'multiple_choice', 
            text: '28. According to the writer, iconoclasts are distinctive because', 
            options: [
          ...
          { 
            id: 29, 
            type: 'multiple_choice', 
            text: '29. According to the writer, the brain works efficiently because', 
            options: [
          ...
          { 
            id: 30, 
            type: 'multiple_choice', 
            text: '30. The writer says that perception is', 
            options: [
          ...
          { 
            id: 31, 
            type: 'multiple_choice', 
            text: '31. According to the writer, an iconoclastic thinker', 
            options: [
...
NOT GIVEN if it is impossible to say what the writer thinks about this`,
        questions: [
          { id: 32, type: 'yes_no_not_given', text: '32. Exposure to different events forces the brain to think differently.', answer: 'YES' },
          { id: 33, type: 'yes_no_not_given', text: '33. Iconoclasts are unusually receptive to new experiences.', answer: 'YES' },
          { id: 34, type: 'yes_no_not_given', text: '34. Most people are too shy to try different things.', answer: 'NOT GIVEN' },
          { id: 35, type: 'yes_no_not_given', text: '35. If you think in an iconoclastic way, you can easily overcome fear.', answer: 'NO' },
          { id: 36, type: 'yes_no_not_given', text: '36. When concern about embarrassment matters less, other fears become irrelevant.', answer: 'NOT GIVEN' },
          { id: 37, type: 'yes_no_not_given', text: '37. Fear of public speaking is a psychological illness.', answer: 'NO' }
        ]
      },
      {
...
E involves understanding how organisations manage people.`,
        questions: [
          { id: 38, type: 'fill_in_the_blank', text: '38. Thinking like a successful iconoclast is demanding because it', answer: 'A' },
          { id: 39, type: 'fill_in_the_blank', text: '39. The concept of the social brain is useful to iconoclasts because it', answer: 'B' },
          { id: 40, type: 'fill_in_the_blank', text: '40. Iconoclasts are generally an asset because their way of thinking', answer: 'C' }
        ]
      }
    ]
  }
...
console.log('Successfully inserted IELTS Reading Test 2 with all 40 questions and full passages!');
