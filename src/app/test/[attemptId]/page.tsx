    ...
    <div className="h-full flex">
      ...
      <div className="w-1/2 h-full overflow-y-auto p-8 border-r border-slate-200 relative bg-slate-50">
        {currentSection === 'listening' ? (
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Writing Task 1</h2>
            <div className="prose prose-slate max-w-none text-slate-700 leading-relaxed space-y-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              <p className="font-bold">You should spend about 20 minutes on this task.</p>
              ...
              <p className="font-bold">Summarise the information by selecting and reporting the main features, and make comparisons where relevant.</p>
      ...
      <div className="w-1/2 h-full overflow-y-auto p-8 bg-white">
        {currentSection === 'writing' ? (
          <div className="flex flex-col h-full">
            ...
            <textarea 
              className="flex-1 w-full p-4 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-none font-medium text-slate-700" 
              placeholder="Start typing your response here..."
            ></textarea>
            <div className="mt-4 text-right text-sm text-slate-500 font-medium">Word count: 0</div>
          </div>
        ) : (
          <>
